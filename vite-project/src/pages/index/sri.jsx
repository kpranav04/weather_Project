...
const {user}=useContext(AuthContext);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const res = await axios.post('http://localhost:3000/index/sri_post', { location: selectedOption.value, month: cred.month, year: cred.year, index: data.sri_index, value: data.valuee });
    console.log(res);
  };
