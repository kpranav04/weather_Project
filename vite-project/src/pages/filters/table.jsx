...
const Tabble = ({ item, index }) => {
    ...
    const handleSubmitButton = async (e) => {
        ...
        const result = await axios.put("http://localhost:3000/index/edit", {id:item._id,data:editData});
    ...
    const handleDelete = async (e)=>{
        e.preventDefault();
        const result = await axios.put("http://localhost:3000/index/delete", {id:item._id});
